return class extends Mod {
  ...
  main() {
    ...
    let texture = new Image(),
      init = () => {
        let lib = api.storage.get("libraries");
        if (lib) return JSON.parse(lib);
        api.storage.set("libraries", "[]");
        return [];
      },
      plver = "1.1_b";

    api.registerMenuHook("snapMenu", (menu) => {
      let menuItemText = () => {
      ...
      menu.addItem(
        menuItemText(),
        () => {
          let a = new DialogBoxMorph().inform(
            "PL Mod | About",
            `PL mod v${plver}
...
Expanded by @d016 (e016 on github).
${
...
https://tethrxt.neocities.org/snap/mods`,
    ...
    api.registerMenuHook("projectMenu", function (menu) {
      let pl = new MenuMorph(this);
      pl.bgColor = this.getControlBarColor ? this.getControlBarColor() : null;
      ...
      pl.addItem(
        ...
        () => {
          ...
          b.addButton(() => {
            ...
            b.fixLayout();
            api.storage.set("libraries", JSON.stringify(libs));
          }, "↓");
          b.addButton(() => {
            var libs = b.librariesData,
              idx = libs.indexOf(b.listField.selected);
      ...
      pl.addItem(
        ...
        () => {
          ...
          //      "yet ready, but soon enough it will be!", api.world);
      ...
      pl.addItem(
        ...
        () => {
          ...
          ProjectDialogMorph.prototype.fixListFieldItemColors.call(
            exportDialog,
          );
...
xml=${targetLib.xml}`;
              ...
              creator.addButton(() => {
                ...
                if (
                  ...
                  libraryData.push({
                    xml: xml,
                    name:
                      libTitleInput.contents().text.text || "Unnamed Library",
      ...
      menu.addMenu("Personal libraries...", pl);
    });
  }
  cleanupFunc() {}
};
